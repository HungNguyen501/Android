...
public class MainActivity extends AppCompatActivity {
    ...
    private void createTable() {
        ...
        try {
            ...
            //insert data
            db.execSQL("insert into studentTable(mssv, fullname, birthday, email, hometown) values('20162001', 'AAA', '12/05/1998', 'a@gmail.com', 'Bac Ninh')");
            db.execSQL("insert into studentTable(mssv, fullname, birthday, email, hometown) values('20162002', 'BBB', '12/06/1998', 'b@gmail.com', 'Bac Ninh')");
            db.execSQL("insert into studentTable(mssv, fullname, birthday, email, hometown) values('20162003', 'CCC', '12/07/1998', 'c@gmail.com', 'Bac Ninh')");
        ...
        customDialog.findViewById(R.id.btn_submit_insert).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ( editText_mssv.getText().toString().isEmpty() ||
                    ...
                    try {
                        //insert data
                        db.execSQL("insert into studentTable(mssv, fullname, birthday, email, hometown) " +
                                "values( '" +
                                editText_mssv.getText().toString() + "', '" +
                                editText_fullname.getText().toString() + "', '" +
                                editText_birtday.getText().toString() + "', '" +
                                editText_email.getText().toString() + "@gmail.com', '" +
    ...
    private void showFindCustomDialog() {
        final Dialog customDialog = new Dialog(MainActivity.this);
        customDialog.setContentView(R.layout.custom_dialog_find);
    ...
    private void showUpdateCustomDialog(final String table_id) {
        final Dialog customDialog = new Dialog(MainActivity.this);
        customDialog.setContentView(R.layout.custom_dialog_update);
